...
insert  into `book`(`bookid`,`authorname`,`bookname`,`language`,`edition`,`category`) values ('1','azees','java','english','2014','novel'),('2','az','ga','tamil','2015','novel');
...
insert  into `register`(`fname`,`lname`,`mail`,`mob`,`pass`,`pid`) values ('muthalib','muthalib','uniq.jega@gmail.com','9840930414','123456','5647'),('jaga','jaga','jagadeesan@uniqtechnologies.co.in','7299300077','123123','0611');
...
insert  into `wallet`(`mobile`,`amount`,`pass`) values ('9840930414',1065,'123456'),('7299300077',9425,'123123');
